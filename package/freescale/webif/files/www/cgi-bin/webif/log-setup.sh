...
header "System" "Syslog Settings" "@TR<<Syslog Settings>>" ' onload="modechange()" ' "$SCRIPT_NAME"
...
helpitem|Log Size
helptext|HelpText Log Size#The size of your log in kilo bytes. Be carefull with the size of the circular buffer as it is taken from your main memory.
end_form
...
footer ?>
<!--
##WEBIF:name:System:150:Syslog Settings
-->
