...
PYTHON_VERSION=3.4
PYTHON_BINABI=3.4m
PYTHON_LIBABI=cpython-34m

PYTHON_DIR:=$(STAGING_DIR)/usr
PYTHON_BIN_DIR:=$(PYTHON_DIR)/bin
PYTHON_INC_DIR:=$(PYTHON_DIR)/include/python$(PYTHON_BINABI)
PYTHON_LIB_DIR:=$(PYTHON_DIR)/lib/python$(PYTHON_VERSION)

PYTHON_PKG_DIR:=/usr/lib/python$(PYTHON_VERSION)/site-packages

PYTHON:=python$(PYTHON_BINABI)

HOST_PYTHON_BIN:=$(STAGING_DIR)/usr/bin/hostpython3
