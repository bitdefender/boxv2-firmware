...
# This pubkey for validating modules at insmod is embedded in the uImage.

define Kernel/SymlinkKeys
	[ -e $(TOPDIR)/signing_key.x509 ]
	ln -sf $(TOPDIR)/signing_key.x509 $(LINUX_DIR)
endef
